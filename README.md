...
Este repo hace pareja con **aws-typescript** y **azure-python**: los tres implementan el mismo dominio de agendamiento de citas y Clean Architecture, los mismos 4 endpoints, distinto cloud/lenguaje — mantenidos en paridad funcional a propósito. Los cinco proyectos de Product Management forman un segundo grupo así, compartiendo ese otro dominio en su lugar.
