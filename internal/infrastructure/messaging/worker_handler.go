...
// NewWorkerHandler returns an http.Handler for a Cloud Run Pub/Sub push subscription
// (PE or CL, filtered by the "country" message attribute at the subscription level - see
// terraform/pubsub.tf). Mirrors AppointmentWorkerBase in the Azure sibling: on failure it
